...
class JokeAdapter : RecyclerView.Adapter<JokeAdapter.JokeViewHolder>() {
    ...
    override fun onBindViewHolder(holder: JokeAdapter.JokeViewHolder, position: Int) {
        val textJoke = holder.constraintLayout.findViewById<TextView>(R.id.textView)
        val m: String = mocked[position]
        textJoke.text = m
        //holder.constraintLayout.R.id.textView= mocked[position]
    }
